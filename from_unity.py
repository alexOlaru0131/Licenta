...
def run() -> None:
        ...
        vision_thread = Thread(
            target=vision_process.vision_thread, args=(tof_image, tof_image)
        )
        ...
        #     ax.scatter(points_x, points_y, 0)
            ...
            session = onnxruntime.InferenceSession(
                "/home/alexolaru131/LicentaRL/ml-agents/results/Training/Training.onnx"
            )
