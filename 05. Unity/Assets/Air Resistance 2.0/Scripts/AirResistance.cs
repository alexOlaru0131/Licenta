...
namespace AirResistance2
{
	...
	public class AirResistance : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			rigidbodyDrag = rigidbody.linearDamping;
		...
		private void FixedUpdate()
		{
			...
			Vector3 up = -rigidbody.linearVelocity.normalized;
		...
		private float CalculateAirResistanceForce()
		{
			...
			float v2 = rigidbody.linearVelocity.sqrMagnitude;
			return c * v2;
		}
		...
		{
			float e = 0.5f * rigidbody.mass * rigidbody.linearVelocity.sqrMagnitude; // Linear KE
